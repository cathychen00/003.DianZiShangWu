<%@ Page StylesheetTheme="default" Language="C#" AutoEventWireup="true" CodeFile="addHelpClass.aspx.cs" Inherits="admin_addHelpClass" %>
    ...
    <TD>
      ...
      border=0>
			  ...
			  <td>
                  ...
                  <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataSourceID="ObjectDataSource1"
                      ...
                      <Fields>
                          ...
                          <asp:CheckBoxField DataField="IsVisible" HeaderText="是否现实首页" SortExpression="IsVisible" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"
            OldValuesParameterFormatString="original_{0}" SelectMethod="GetHelpClassByID" TypeName="Jiaen.BLL.HelpClass" DataObjectTypeName="Jiaen.Components.HelpClassInfo" InsertMethod="InsertHelpClass" UpdateMethod="UpdateHelpClass">
            <SelectParameters>
                <asp:QueryStringParameter Name="HelpClassID" QueryStringField="edit" Type="Int32" />
            </SelectParameters>
