<%@ Page Language="C#" AutoEventWireup="true" CodeFile="downList.aspx.cs" Inherits="admin_downList" %>
			  ...
			  <td>
                  ...
                  <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                      ...
                      <Columns>
                          ...
                          <asp:BoundField DataField="Rate" HeaderText="评价" SortExpression="Rate" />
                          <asp:BoundField DataField="DownURL" HeaderText="下载地址" SortExpression="DownURL" />
                          <asp:BoundField DataField="DownCount" HeaderText="下载次数" SortExpression="DownCount" />
                          ...
                          <asp:TemplateField HeaderText="管理" ShowHeader="False">
                              ...
                              <ItemTemplate>
                                  <asp:HyperLink NavigateUrl='<%# "addDownLoad.aspx?edit="+Eval("downID")%>' ID="HyperLink1" runat="server">编辑</asp:HyperLink>
    ...
    <TD class=Left_04 vAlign=bottom width=8 style="height: 19px"><IMG height=8 
      src="../images/Admin_1.gif" width=8></TD></TR></TBODY></TABLE>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="Jiaen.Components.DownLoadInfo"
            DeleteMethod="DeleteDownLoad" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDownLoad"
