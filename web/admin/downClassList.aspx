<%@ Page Language="C#" AutoEventWireup="true" CodeFile="downClassList.aspx.cs" Inherits="admin_downClassList" %>
          ...
          <TD  style="FONT-SIZE: 12px">
			  ...
			  <td>
                  ...
                  <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                      DataKeyNames="ID" DataSourceID="ObjectDataSource1" SkinID="orange">
                      <Columns>
  ...
  <TR>
    ...
    <TD class=Left_04 vAlign=bottom width=8 style="height: 19px"><IMG height=8 
      src="../images/Admin_1.gif" width=8></TD></TR></TBODY></TABLE>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="Jiaen.Components.DownClassInfo"
            DeleteMethod="DeleteDownClass"
            SelectMethod="GetDownClass" TypeName="Jiaen.BLL.DownClass" UpdateMethod="UpdateDownClass" OldValuesParameterFormatString="original_{0}" >
