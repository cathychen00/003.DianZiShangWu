<%@ Control Language="C#" AutoEventWireup="true" CodeFile="catBook.ascx.cs" Inherits="Control_catBook" %>
...
<ItemTemplate>
    <div class="third-1">
        ...
        <div class="third-002">
            <a href=" " target="_blank"><strong><%# Eval("bookName") %></strong></a><br />
            <%# Eval("bookPublish") %><br>
    ...
    <div class="third-1">
        ...
        <cc1:collectionpager id="CollectionPager1" runat="server" resultslocation="None" PageSize="10" BackNextLinkSeparator="|" BackText="上一页" FirstText="第一页" LabelText="第" LastText="最后一页" NextText="下一页" PageNumbersSeparator="-" ShowFirstLast="False" backnextlocation="Right" pagenumbersdisplay="Numbers"></cc1:collectionpager>共<asp:Label ID="Label1" runat="server"></asp:Label>本
        <br />
