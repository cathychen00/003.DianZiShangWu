    ...
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
        <asp:View ID="View1" runat="server">
            ...
            <div class="reg-main">
                <label>
                    <div align="center">
                        <textarea name="ServiceTxt" cols="100" rows="30" id="ServiceTxt" runat="server" enableviewstate="false">
                ...
                <div class="reg-button" align="center">
                    <input id="agree" style="width: 80px; border-top-style: ridge; border-right-style: ridge;
                    ...
                    <input id="unagree" style="width: 80px; border-top-style: ridge; border-right-style: ridge;
                        border-left-style: ridge; height: 29px; border-bottom-style: ridge" type="submit"
                        value="我不同意" name="unagree" runat="server" onserverclick="unagree_ServerClick"></div>
            </div>
        </asp:View>
        <asp:View ID="View4" runat="server">
            <div class="register-01">
                <img src="images/Reg_02.jpg" width="121" height="50" />（带为<font color="red">☆</font>必填项）</div>
            <div class="register-02">
                <p>
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <input type="button" value="检查会员名是否可用" name="check_username" id="Button1" runat="server"
            ...
            <div>
                <p>
                    ...
                    <table id="table6" cellspacing="0" cellpadding="5" width="700" border="0">
                        <tbody>
                            <tr height="28">
                                <td align="right" width="140" style="height: 28px">
                                    密码：<font color="red">☆</font></td>
                                ...
                                <td width="330" style="height: 28px">
                                    <div id="password_info">
                                        <div id="div" inherits="HintMsg">
                                            密码由6-16个英文字母、数字或符号组成。</div>
                                    </div>
                                </td>
                            </tr>
                            <tr height="28">
                                <td align="right">
                                    再次输入密码：<font color="red">☆</font></td>
                                <td width="200">
                                ...
                                <td>
                                    <div id="question_info">
                                        <div id="div3" inherits="HintMsg">
                                            您可以选择一个问题作为找回密码的提示。</div>
                                    </div>
                                </td>
                            </tr>
                            <tr height="55">
                                <td align="right">
                                    答案：<font color="red">☆</font></td>
                                <td>
                                ...
                                <td>
                                    <div id="answer_info">
                                        <div id="div4" inherits="HintMsg">
                                            请输入提示问题答案，在密码丢失之后您可以通过[找回密码]</div>
                                    </div>
                                </td>
                            </tr>
                            <tr height="40">
                                <td align="right">
                                    电子邮件地址：<font color="red">☆</font></td>
                                <td>
                                ...
                                <td>
                                    <div id="email_info">
                                        请正确的输入您常用的电子邮件地址。</div>
                                </td>
                            </tr>
                            <tr height="28">
                                <td align="right">
                                    验证码：<font color="red">☆</font></td>
                                <td>
        ...
        <asp:View ID="View3" runat="server">
            <br>
            <div class="register-01">
                <img src="images/reg-04.jpg" width="160" height="50" /></div>
                        ...
                        <tbody>
                            <tr height="28">
                                <td width="68" height="34">
                                    &nbsp;</td>
                                <td colspan="3" align="center" valign="top" class="ff9clolor">
                                    恭喜您已经成为迦恩网络书店会员</td>
                                <td width="212">
                                    &nbsp;</td>
                            </tr>
            ...
            <br />
            <div align="center">
                <input id="returnIndex" style="width: 80px; border-top-style: ridge; border-right-style: ridge;
                    border-left-style: ridge; height: 29px; border-bottom-style: ridge" type="submit"
