                                                            ...
                                                            <table cellspacing="5" cellpadding="0" width="90%" border="0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2">
                                                                            <font color="red">
                                                                                <asp:Literal ID="FailureText" runat="server" EnableViewState="False"></asp:Literal></font></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="3">如果您在公共场所使用，建议不选择此项</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>&nbsp;</td>
                                                                        <td width="76">
                                                                    ...
                                                                    <tr valign="top">
                                                                        <td align="right" colspan="3" style="height: 19px">
                                                                            <div align="center">
                                                                                <a href="pwd.aspx" target="_blank">忘记密码</a>&nbsp;
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
