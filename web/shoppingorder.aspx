<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shoppingorder.aspx.cs" Inherits="shoppingorder" %>
...
<body>
    <form id="form1" runat="server">
        <div class="shopwhole">
 <uc2:cartHelp ID="CartHelp1" runat="server" />
                            ...
                            <td width="729" height="333" valign="top">
                                <table cellspacing="0" cellpadding="3" width="80%" align="center" border="0">
                                    <tbody>
                                            ...
                                            <td>
                                                ...
                                                <table cellspacing="0" cellpadding="3" width="100%" align="center" bgcolor="#ececff"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td colspan="3">
                                                                地址：<asp:Label ID="Address" runat="server" Text='<%# Eval("Address") %>' /></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <b>您所要购买商品的购物清单</b>&nbsp;&nbsp;&nbsp;&nbsp;<a runat=server href="ShoppingCart.aspx" id="cart"><u><font color="#000099">修改购物清单</font></u></a></td>
                                        </tr>
                                        <tr>
                                            <td style="height: 88px">
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" bgcolor="#ececff" width="100%" border="0">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td width="33%">
                                                                        优惠价：<asp:Label ID="Price" runat="server" Text='<%# Bind("MemberPrice","{0:c}") %>'></asp:Label>&nbsp;&nbsp;&nbsp;数量：<%# Eval("Quantity") %><asp:Label
                                                ...
                                                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" DeleteMethod="DeleteCart"
                                                    SelectMethod="SelectCart" TypeName="Jiaen.BLL.ShoppingCart">
                                                    <DeleteParameters>
