<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TgShoppingCart.aspx.cs" Inherits="TgShoppingCart" %>
...
/></DIV>
            ...
            <div class="shop-main">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                    ...
                    <Columns>
                        ...
                        <ItemStyle BackColor="#FFF9EC" HorizontalAlign="Center" />
                            <HeaderStyle Width="10%" />
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("VipPrice") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <font color=red>￥<asp:Label ID="vipPrice" runat="server" Text='<%# Bind("VipPrice") %>'></asp:Label></font>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="数量">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:RangeValidator ControlToValidate="quantityTxt" id="RangeValidator1" runat="server" ErrorMessage="*" MaximumValue="50" MinimumValue="0"></asp:RangeValidator>
                        ...
                        <tr bgcolor="#fff9ec">
                            <td colspan="6" height="36">
                                <div align="center">
                                    ...
                                    团购总价：<asp:Label ID="tgAllPriceTxt" runat="server" Font-Italic="True"></asp:Label>元</div>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"
                    SelectMethod="SelectTgCart" TypeName="Jiaen.BLL.ShoppingCart" DeleteMethod="DeleteCart">
                    <DeleteParameters>
                        <asp:Parameter Name="bookID" Type="Int32" />
                        <asp:Parameter DefaultValue="True" Name="isTg" Type="Boolean" />
                    </DeleteParameters>
