...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="showInfo-main">
        ...
        <div class="loginInfo-main-right">
            <br />
            <div class="ff9clolor">
                <img src="../images/usercenter.jpg" width="160" height="50" />欢迎来到迦恩计算机网站中心!
            </div>
            <table cellspacing="0" cellpadding="0" width="502" border="0" align="left">
                <!--DWLayoutTable-->
                <tbody>
                    <tr>
                        <td width="500" height="24" valign="top">尊敬的<asp:Label ID="userTxt" runat="server" Text="Label"></asp:Label>,您好!欢迎访问迦恩计算机图书网!</td>
                        <td width="4">&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td height="50" valign="top" style="border-left: #c2c2c2 1px solid; border-right: #c2c2c2 1px solid;">
                            ...
                            <table id="table6" cellspacing="0" cellpadding="5" width="90%" border="0">
                                ...
                                <tbody>
                                    <tr height="40">
                                        ...
                                        <td>&nbsp;<asp:TextBox ID="emailTxt" runat="server" Width="226px"></asp:TextBox>
                            ...
                            <div align="center">
                                <img height="1" src="../images/line.gif" width="304">
                            </div>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
